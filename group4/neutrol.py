...
if __name__ == '__main__':
    ...
    trainStep = 10000000
    rawdata_rows = 10000
    rawdata_trainRow = 9800
    rawdata_testRow = rawdata_rows - rawdata_trainRow
    rawdata_trainCol = 33
    rawdata_labelCol = 5
    saver_path = "./"
    checkPoint = trainStep / 10000
    start_time = datetime.datetime.now()
    rawdata = np.loadtxt('../sourceData/Train_Test_Data_8000db_multlay.csv', dtype=float, delimiter=',',
    ...
    train_data, train_label = np.hsplit(train, np.array([rawdata_trainCol, ]))
